...
namespace Tesco.Com.Web.Core.UIAssets
{
    ...
    {
        public AppCacheResult(List<string> cacheAssets, IEnumerable<string> networkAssets = null,
            IDictionary<string, string> fallbackAssets = null, string fingerprint = null)
        {
            if (cacheAssets == null)
            {
